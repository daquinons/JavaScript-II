...
let ticketPrice = runners.map((element) => element.donation)
let ticketPriceTotal = ticketPrice.reduce( (accumulator, currentValue, currentIndex, array) => accumulator + currentValue );
...
// Problem 1
// Count how many S shirts we will need

let sShirts = runners.filter(a => a.shirt_size === "S");
console.log( sShirts.length);

// Problem 2
// People who donated more than 100€ will get an special gift. List all those people
let donatorsOver100 = runners.filter(a => a.donation > 100);
console.log(donatorsOver100);

// Problem 3
// List all the different companies that are participating to have them as sponsors
let companies = []
